    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (File.Exists(path)) {
                ...
                List<(string a, string i)> laling = new List<(string a, string i)>();
                ...
                string comma = "";
                foreach( (string,string) item in laling) {
                    Console.Write(comma + item.Item2);
                    comma = ",";
                }
            }
        }
